<template>
  <div class="fullpage-container">
    <div class="fullpage-wp" v-fullpage="fullpageOptions" ref="fullpage">
      <div id="section1" class="page-1 page">
      ...
      <div id="section2" class="page-2 page">
      ...
      <div id="section3" class="page-3 page">
  ...
  data: () => ({
    ...
    fullpageOptions: {
      ...
      beforeChange: function (currentSlideEl, currenIndex, nextIndex) {
        console.log("berfore", currenIndex, nextIndex);
        this.index = nextIndex;
      },
      afterChange: function (currentSlideEl, currenIndex) {
        this.index = current;
        console.log("after", currenIndex);
      },
    },
    v0: true,
    cards: [
